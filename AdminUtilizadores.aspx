...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="catadmin">
        ...
        <asp:Button ID="Button1" class="catadminbutton" runat="server" Text="Utilizadores" />
        <br />
        <asp:Button ID="Button2" class="catadminbutton" runat="server" Text="Telemoveis" />
        <br />
        <asp:Button ID="Button3" class="catadminbutton" runat="server" Text="Tablets" />
        <br />
        <asp:Button ID="Button4" class="catadminbutton" runat="server" Text="Acessorios" />
    ...
    <div class="tableuse">
        ...
        <asp:Label ID="Label1" CssClass="subtext" runat="server" Text="Nome"></asp:Label>
        <br />
        <asp:TextBox ID="txtnome1" CssClass="gimmyspace" runat="server" Width="145px"></asp:TextBox>
        <asp:TextBox ID="txtnome2" runat="server" Width="145px" CssClass="rightgogo"></asp:TextBox>
        <asp:Label ID="Label2" runat="server" Text="PalavraPasse"></asp:Label>
        <br />
        <asp:TextBox ID="txtpass" CssClass="gimmyspace" runat="server" Width="100%"></asp:TextBox>
        <br />
        <asp:Label ID="Label3" runat="server" Text="Email"></asp:Label>
        <br />
        <asp:TextBox ID="txtemail" CssClass="gimmyspace" runat="server" Width="100%"></asp:TextBox>
        <br />
        ...
        <br />
        <asp:TextBox ID="txtrua" CssClass="gimmyspace" runat="server" Width="100%"></asp:TextBox>
        <br />
        <asp:Label ID="Label6" runat="server" Text="Cidade"></asp:Label>
        <br />
        <asp:TextBox ID="txtcidade" CssClass="gimmyspace" runat="server" Width="100%"></asp:TextBox>
        <br />
        <asp:Label ID="Label7" runat="server" Text="Distrito"></asp:Label>
        <br />
        <asp:TextBox ID="txtdistrito" CssClass="gimmyspace" runat="server" Width="100%"></asp:TextBox>
        <br />
        <asp:Label ID="Label8" runat="server" Text="CodigoPostal"></asp:Label>
        <br />
        <asp:TextBox ID="txtcp1" CssClass="gimmyspace" runat="server" MaxLength="4" Width="42px"></asp:TextBox>
        -
        <asp:TextBox ID="txtcp2" runat="server" MaxLength="3" Width="34px"></asp:TextBox>
        <br />
        <asp:Label ID="Label9" runat="server" Text="Contribuinte"></asp:Label>
        <br />
        <asp:TextBox ID="txtcont" CssClass="gimmyspace" runat="server" MaxLength="9" Width="100%"></asp:TextBox>
        <br />
        <asp:Label ID="Label10" runat="server" Text="Dinheiro"></asp:Label>
        <br />
        <asp:TextBox ID="txtdinheiro" CssClass="gimmyspace" runat="server" Width="100%"></asp:TextBox>
        <br />
        <asp:Label ID="Label11" runat="server" Text="Imagem"></asp:Label>
        <br />
        <asp:FileUpload ID="iuser" runat="server" />
        <br />
